...
namespace Gigya.Microdot.UnitTests.Discovery.Rewrite
{
    ...
    public class MultiEnvironmentServiceDiscoveryConfigChangeTest
    {
        ...
        public async Task Setup()
        {
            ...
            {
                k.Rebind<IEnvironment>().ToConstant(new HostConfiguration(new TestHostEnvironmentSource()));
        ...
        public async Task ServiceSourceIsLocal()
        {
            ...
            var node = await _serviceDiscovery.GetNode();
            node.Node.Hostname.ShouldContain(CurrentApplicationInfo.s_HostName);
        }
