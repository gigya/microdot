...
namespace Gigya.Microdot.SharedLogic.Measurement.Workload
{
    public sealed class WorkloadMetricsLinux : IWorkloadMetrics
    {
        ...
        public void Init()
        {
            ...
            _context.Context("CPU").Gauge("Machine IoWait Usage", () => _cpuUsageCalculator.Calculate().MachineIoWait ?? 0, Unit.Percent);
            _context.Context("CPU").Gauge("Process Cpu Usage", () => _cpuUsageCalculator.Calculate().ProcessCpuUsage, Unit.Percent);
